                        ...
                        >
                            <form @submit.prevent="handleSubmit" class="space-y-6">
                                <div class="flex items-start justify-between border-b border-surface-100 px-6 py-4">
                                    <div>
                                        <h2 class="text-lg font-semibold text-surface-900">Record Treatment</h2>
                                ...
                                <div class="space-y-6 px-6">
                                    <div class="grid gap-4 sm:grid-cols-2">
                                        <div class="space-y-1">
                                            <label class="text-xs font-semibold uppercase tracking-wide text-surface-500">Treatment Date <span class="text-red-500">*</span></label>
                                            <input
                                        ...
                                        <div class="space-y-1">
                                            <label class="text-xs font-semibold uppercase tracking-wide text-surface-500">Assigned Vet</label>
                                            <select
                                                v-model="form.vet_id"
                                                class="w-full rounded-lg border border-surface-200 px-3 py-2 text-sm focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-200"
                                            >
                                        ...
                                        <div class="space-y-1 sm:col-span-2">
                                            <label class="text-xs font-semibold uppercase tracking-wide text-surface-500">Diagnosis</label>
                                            <input
                                        ...
                                        <div class="space-y-1 sm:col-span-2">
                                            <label class="text-xs font-semibold uppercase tracking-wide text-surface-500">Reason</label>
                                            <textarea
                                        ...
                                        <div class="space-y-1">
                                            <label class="text-xs font-semibold uppercase tracking-wide text-surface-500">Medication</label>
                                            <input
                                        ...
                                        <div class="space-y-1">
                                            <label class="text-xs font-semibold uppercase tracking-wide text-surface-500">Dosage</label>
                                            <div class="flex gap-2">
                                                ...
                                                <input
                                                    ...
                                                    type="text"
                                                    placeholder="Unit"
                                                    class="w-28 rounded-lg border border-surface-200 px-3 py-2 text-sm focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-200"
                                                />
                                            </div>
                                        </div>
                                        <div class="space-y-1">
                                            <label class="text-xs font-semibold uppercase tracking-wide text-surface-500">Route</label>
                                            <input
                                        ...
                                        <div class="space-y-1">
                                            <label class="text-xs font-semibold uppercase tracking-wide text-surface-500">Follow-up Date</label>
                                            <input
                                        ...
                                        <div class="space-y-1">
                                            <label class="text-xs font-semibold uppercase tracking-wide text-surface-500">Outcome</label>
                                            <select
                                        ...
                                        <div class="space-y-1">
                                            <label class="text-xs font-semibold uppercase tracking-wide text-surface-500">Cost</label>
                                            <input
                                        ...
                                        <div class="space-y-1">
                                            <label class="text-xs font-semibold uppercase tracking-wide text-surface-500">Lifecycle Status</label>
                                            <select
                                        ...
                                        <div class="space-y-1 sm:col-span-2">
                                            <label class="text-xs font-semibold uppercase tracking-wide text-surface-500">Next Steps</label>
                                            <textarea
                                        ...
                                        <div class="space-y-1 sm:col-span-2">
                                            <label class="text-xs font-semibold uppercase tracking-wide text-surface-500">Notes</label>
                                            <textarea
                                ...
                                <div class="flex flex-col gap-2 border-t border-surface-100 bg-surface-50 px-6 py-4 sm:flex-row sm:justify-end">
                                    <button
                                        type="button"
                                        class="inline-flex items-center gap-2 rounded-lg border border-surface-200 px-4 py-2 text-sm font-medium text-surface-600 hover:bg-white disabled:cursor-not-allowed disabled:opacity-50"
                                        @click="handleClose"
                                        :disabled="submitting"
                                    >
                                        Cancel
