...
class SlugGenerator
{
    ...
    protected static function slugExists(string $slug, string $table, ?int $ignoreId = null): bool
    {
        ...
        if ($table === 'regions') {
            $field_name = 'region_slug';
        } elseif ($table === 'districts') {
            $field_name = 'district_slug';
        } elseif ($table === 'counties') {
            $field_name = 'county_slug';
        } elseif ($table === 'subcounties') {
            $field_name = 'subcounty_slug';
        } elseif ($table === 'parishes') {
            $field_name = 'parish_slug';
        } elseif ($table === 'villages') {
            $field_name = 'village_slug';
        } else {
            $field_name = 'slug';
        }
